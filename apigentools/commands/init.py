...
@click.pass_context
def init(ctx, projectdir, no_git_repo):
    """Initialize a new spec repository.

    The project drectory will be created if it doesn't exist.
    """
    cmd_result = 0
    log.info("Initializing a new project directory")

    os.makedirs(projectdir, exist_ok=True)
    with change_cwd(projectdir):
        dirs = {
