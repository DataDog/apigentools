...
from apigentools.utils import get_full_spec_file_name, glob_re, run_command, volumes_from
    ...
    def run_config_command(
        ...
        for part in self._render_command_args(command.commandline, chevron_vars):
            if isinstance(part, dict):
                allowed_functions = {"glob": glob.glob, "glob_re": glob_re, "volumes_from": volumes_from}
